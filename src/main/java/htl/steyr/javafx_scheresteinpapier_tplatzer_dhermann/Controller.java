...
//        initializeImageBox(box, image);
    ...
    private void startAnimation() {
        Platform.runLater(() -> {
            ...
            ParallelTransition parallelTransition = new ParallelTransition(topBarAnimation,
                    bottomBarAnimation,
